...
namespace Common.Base.BaseCommon
{
    ...
    public static class GlobalStaticParam
    {
        ...
        public static object GetByCode(string code, bool throwOnError)
        {
            ...
            if (throwOnError)
            {
                throw new Exception(string.Format("键值{0}没有在系统配置中配置.", code));
            }
        ...
        {
            string connectionString = ConfigurationManager.AppSettings["DBConStrings"]["MainConStrings"].ToString();
        ...
        public static string ReadConnectionString(string Key)
        {
            ...
            //{
            //    throw new Exception("配置文件中没有找到该Key!");
            //}
