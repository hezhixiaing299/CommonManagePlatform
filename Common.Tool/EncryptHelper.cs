...
namespace Common.Tool
{
    ...
    public class DEncrypt
    {
        ...
        public static string Get32_MD5Uper(string strSource, Encoding sEncode)
        {
            if (sEncode == null)
            {
        ...
        /// <returns></returns>
        public static string Get16_Md5Uper(string strSource, Encoding sEncode)
        {
            ...
            //获取密文字节数组
            byte[] bytResult = md5.ComputeHash(sEncode.GetBytes(strSource));
            string t2 = BitConverter.ToString(bytResult, 4, 8);
        ...
        /// <param name="ConvertString"></param>
        /// <returns></returns>
        public static string Get16_Md5Lower(string strSource, Encoding sEncode)
        {
            MD5CryptoServiceProvider md5 = new MD5CryptoServiceProvider();
            if (sEncode == null)
            {
            ...
            t2 = t2.Replace("-", "");
            t2 = t2.ToLower();
            //var cutbyte = bytResult.Skip(4).Take(8).ToArray();
            //var validateStr = BitConverter.ToString(cutbyte).Replace("-", "").ToLower();
            return t2;
        }
        ...
        /// <param name="ConvertString"></param>
        /// <returns></returns>
        public static byte[] Get16_Md5LowerByte(string strSource, Encoding sEncode)
        {
            MD5CryptoServiceProvider md5 = new MD5CryptoServiceProvider();
            if (sEncode == null)
            {
                sEncode = UTF8Encoding.Default;
            }
            byte[] bytResult = md5.ComputeHash(sEncode.GetBytes(strSource));
            var cutbyte = bytResult.Skip(4).Take(8).ToArray();
            //var validateStr = BitConverter.ToString(cutbyte).Replace("-", "").ToLower();
    ...
    public class DESEncrypt
    {
        ...
        public static string Encrypt(string Text, string sKey)
        {
            ...
            des.Key = MD5.Create().ComputeHash(Encoding.ASCII.GetBytes(sKey));
            des.IV = MD5.Create().ComputeHash(Encoding.ASCII.GetBytes(sKey));
