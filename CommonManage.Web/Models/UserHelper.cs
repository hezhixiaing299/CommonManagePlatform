...
//        /// </summary>
//        private static readonly string userCommonTokenCookie = "CommonTokenCookie";
...
//            {
//                principalUser = null;
//                GlobalHttpContext.Current.Session.SetString(loginName,null);

//                HttpCookie cookies = HttpContext.Current.Request.Cookies[userCommonTokenCookie];
//                if (cookies != null)
//                {
//                    cookies.Expires = DateTime.Today.AddDays(-1);
//                    HttpContext.Current.Response.Cookies.Add(cookies);
//                    HttpContext.Current.Request.Cookies.Remove(userCommonTokenCookie);
//                }
//            }
//            else
//            {
//                //Session里面不存在
//                if (GlobalHttpContext.Current.Session.GetString(loginName) == null)
//                {
//                    //检查数据库是否有此用户
...
//                        GlobalHttpContext.Current.Session.Set<UserBackFullInfo>(principalUser.LoginName, userdatainfo);
//                    }
//                }
//                else //Session里面存在
//                {
...
//            var cookie = new HttpCookie(userCommonTokenCookie, value) { Expires = expirationTime };
//            //设置域
...
//            var responseCookie = HttpContext.Current.Response.Cookies[userCommonTokenCookie];
...
//            HttpCookie cookie = HttpContext.Current.Request.Cookies[userCommonTokenCookie];
//            if (cookie == null)
//            {
//                return null;
//            }
...
//            string actionName = actionExecutingContext.ActionDescriptor.DisplayName;
